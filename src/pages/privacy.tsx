    ...
    <div className="page">
        <div className="header">
            <div className="container">
                <p className="title">Privacy Policy for Reveal</p>
            </div>
        </div>
            ...
            <div className="container">
                <div className="tab-content translations-content-item en visible" id="en">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to Reveal, accessible from <a href="https://www.reveal-app.site/" rel="external nofollow noopener" target="_blank">https://www.reveal-app.site/</a></p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>By email: support@reveal-app.site</li>
                    </ul>
                </div>
            </div>
        </div>
